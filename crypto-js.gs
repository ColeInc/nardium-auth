        ...
        U =
            ...
            (function (h) {
                ...
                if (
                    ...
                    !(i =
                        !(i =
                            !(i = "undefined" != typeof globalThis && globalThis.crypto ? globalThis.crypto : i) &&
    ...
    return (
            ...
            e.extend({
                ...
                _doProcessBlock: function (t, e) {
                    for (
                        ...
                        a < 16
                            ? (l[a] = 0 | t[e + a])
                            : ((h = l[a - 3] ^ l[a - 8] ^ l[a - 14] ^ l[a - 16]), (l[a] = (h << 1) | (h >>> 31)));
                ...
                _doProcessBlock: function (t, e) {
                    ...
                    for (var c = 0; c < 24; c++) {
                        ...
                        for (var y = 1; y < 25; y++) {
                            ...
                            l =
                                B < 32
                                    ? ((h = (v << B) | (g >>> (32 - B))), (g << B) | (v >>> (32 - B)))
                                    : ((h = (g << (B - 32)) | (v >>> (64 - B))), (v << (B - 32)) | (g >>> (64 - B)));
                            B = C[H[y]];
                            (B.high = h), (B.low = l);
                        }
                        var w = C[0],
        ...
        (M.algo.HMAC = P.extend({
            init: function (t, e) {
                ...
                for (
                    var t = (this._oKey = e.clone()), e = (this._iKey = e.clone()), n = t.words, o = e.words, s = 0;
                    s < r;
                    s++
                )
                    ...
                    l = ((t.format = {}).OpenSSL = {
                        ...
                        parse: function (t) {
                            ...
                            return (
                                1398893684 == t[0] &&
                                    1701076831 == t[1] &&
                                    ((e = s.create(t.slice(2, 4))), t.splice(0, 4), (r.sigBytes -= 16)),
        ...
        (P = P.Rabbit =
            F.extend({
                ...
                _doProcessBlock: function (t, e) {
                    ...
                    for (var i = 0; i < 4; i++)
                        (D[i] =
                            (16711935 & ((D[i] << 8) | (D[i] >>> 24))) | (4278255360 & ((D[i] << 24) | (D[i] >>> 8)))),
                            (t[e + i] ^= D[i]);
                },
                blockSize: 4,
                ivSize: 2,
        ...
        (P = P.RabbitLegacy =
            F.extend({
                ...
                _doProcessBlock: function (t, e) {
                    ...
                    for (var i = 0; i < 4; i++)
                        (W[i] =
                            (16711935 & ((W[i] << 8) | (W[i] >>> 24))) | (4278255360 & ((W[i] << 24) | (W[i] >>> 8)))),
                            (t[e + i] ^= W[i]);
                },
                blockSize: 4,
                ivSize: 2,
